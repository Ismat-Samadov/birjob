        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-700 dark:text-gray-300">We collect personal information that you voluntarily provide to us when you:</p>
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-gray-300">We may also collect information about how you use our service, including:</p>
                  <ul className="list-disc pl-5 mt-2 text-gray-700 dark:text-gray-300">
            ...
            <div className="border-t border-gray-200 pt-4 mt-6">
              <p className="text-sm text-gray-500 dark:text-gray-400">Last updated: May 6, 2025</p>
            </div>
          </CardContent>
        </Card>
      </div>
